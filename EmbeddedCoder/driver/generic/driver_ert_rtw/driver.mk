...
## 
## Makefile     : driver.mk
## Generated on : Tue Jun 25 14:00:31 2024
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/TZJQCA8/Desktop/Performance_Eng/Modeling/Matlab_tutorial/Files/add
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/driver_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/driver_ert_rtw/driver.c

MAIN_SRC = $(START_DIR)/driver_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/driver_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
