...
## 
## Makefile     : add.mk
## Generated on : Tue Jun 25 21:50:29 2024
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/add_ert_rtw -IC:/Users/TZJQCA8/Desktop/Performance_Eng/Modeling/Matlab_tutorial/Files/add -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/add_ert_rtw/add.c

MAIN_SRC = $(START_DIR)/add_ert_rtw/ert_main.c
